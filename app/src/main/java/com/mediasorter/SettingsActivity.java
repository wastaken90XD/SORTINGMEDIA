...
public class SettingsActivity extends Activity {
    ...
    private void buildSettings() {
        ...
        btnExport.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                String path = SettingsExporter.exportSettings(SettingsActivity.this);
                if (path != null) {
            ...
            @Override public void onClick(View v) {
                ...
                new AlertDialog.Builder(SettingsActivity.this)
                    ...
                    .setItems(names, new DialogInterface.OnClickListener() {
                        @Override public void onClick(DialogInterface d, final int w) {
                            new AlertDialog.Builder(SettingsActivity.this)
                                .setTitle("Import?")
                                ...
                                .setPositiveButton("Import", new DialogInterface.OnClickListener() {
                                    @Override public void onClick(DialogInterface d2, int w2) {
                                        boolean ok = SettingsExporter.importSettings(SettingsActivity.this, backups[w].getAbsolutePath());
                                        Toast.makeText(SettingsActivity.this, ok ? "Imported! Restart app." : "Import failed",
                                                Toast.LENGTH_LONG).show();
                                        if (ok) recreate();
                                    }
                                })
